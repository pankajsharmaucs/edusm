        ...
        if (localStorage.getItem('token')) {
            ...
            try {
                ...
                if (response.data.msg === 'success') {
                    ...
                    setAllData(response.data.orderData);
                    setTrackingOrderData(response.data.orderData);

                    console.log(AllData);

                    let order_status = response.data.orderData.order_status;
